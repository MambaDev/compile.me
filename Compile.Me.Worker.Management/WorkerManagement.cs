...
{
    public class WorkerManagement : IHostedService
    {
        /// <summary>
        /// The logger of the service.
        /// </summary>
        private readonly ILogger<WorkerManagement> _logger;
        ...
        public WorkerManagement(ILogger<WorkerManagement> logger, IHostApplicationLifetime applicationLifetime,
    ...
    internal class CompiledResponseQueueMessageHandler : IHandler
    {
        ...
        internal CompiledResponseQueueMessageHandler(ILogger<WorkerManagement> logger)
        {
            this._logger = logger;
        }
